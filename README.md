# 🧶 نسج | Nasij - CraftCourses Platform

منصة سعودية لدورات الحرف اليدوية، تتيح للمستخدمين استعراض الدورات، وحجزها بسهولة، مع تصميم أنيق وتجربة سلسة.

## 💡 فكرة المشروع
"نسج" هي منصة تهدف إلى تمكين المجتمع المهاري المحلي عبر تقديم دورات تعليمية في الحرف اليدوية مثل الكروشيه، التطريز، وصناعة الإكسسوارات. المنصة تُظهر جميع الدورات المتاحة، وتتيح للمستخدم حجز مقعد في الدورة، وإضافة أكثر من دورة إلى سلة الحجز.
